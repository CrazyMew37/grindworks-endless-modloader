...
func final_boss_time_baby() -> void:
	...
	final_floor.level_range = Vector2i(ceili((Util.floor_number) * 0.7 * ((((4 * DifficultyMultiplier) + (floori((Util.floor_number - 1) / 8) / 2))))) - 5 * floori((Util.floor_number + 5) / 10), ceili((Util.floor_number) * 0.7 * ((((4 * DifficultyMultiplier) + (floori((Util.floor_number - 1) / 8) / 2))))))
